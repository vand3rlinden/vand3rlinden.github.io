...
- [My roles in PIM](https://portal.azure.com/#view/Microsoft_Azure_PIMCommon/ActivationMenuBlade/~/aadmigratedroles)
...
- [MDO - Investigations](https://security.microsoft.com/airinvestigation)
- [MDO - Attack Simulation (AST)](https://security.microsoft.com/attacksimulator)
- [MDO - Tenant Allow/Block List](https://security.microsoft.com/tenantAllowBlockList)
- [MDO - Submissions](https://security.microsoft.com/reportsubmission)
- [MDO - Impersonation Insight](https://security.microsoft.com/impersonationinsight)
...
- [XDR - Secure Score](https://security.microsoft.com/exposure-secure-score)
...
- [Sucuri SiteCheck scanner - malware and security checker](https://sitecheck.sucuri.net)
