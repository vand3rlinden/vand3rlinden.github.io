...
> 
> _*If Microsoft 365 is already included in the main SPF record (`include:spf.protection.outlook.com`), it does not need to be listed in the SPF macro as well, since the SPF macro is evaluated at the end of your main SPF record. Listing it twice will result in an error, as `spf.protection.outlook.com` will have already been visited during evaluation before the SPF macro is reached._
