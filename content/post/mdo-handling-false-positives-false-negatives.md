...
Once you report a false negative (questionable email), you can create a block entry in the Tenant Allow/Block List for domains and email addresses, files and URLs. These records expire after 30 days, but you can set them to expire after 90 days or never. Block entries for spoofed senders and IP addresses never expire.
