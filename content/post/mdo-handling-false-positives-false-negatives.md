...
> - **CAUTION**: This approach may lead to false positives due to EOP’s implicit authentication techniques

Even with a strong Microsoft Defender for Office 365 configuration _(for example based on Microsoft's strict recommendations)_, you can still receive False Positives or False Negatives if Microsoft's backend mechanisms/implicit authentication techniques do not flag the email based on the signals they receive.
...
Once you report a false positive ([good email](https://learn.microsoft.com/en-us/defender-office-365/submissions-admin?view=o365-worldwide#report-good-email-to-microsoft)), you can, if desired, create an allow entry in the Tenant Allow/Block List for domains, email addresses, [files](https://learn.microsoft.com/en-us/defender-office-365/submissions-admin?view=o365-worldwide#report-good-email-attachments-to-microsoft), and [URLs](https://learn.microsoft.com/en-us/defender-office-365/submissions-admin?view=o365-worldwide#report-good-urls-to-microsoft). 
...
Once you report a false negative ([questionable email](https://learn.microsoft.com/en-us/defender-office-365/submissions-admin#report-questionable-email-to-microsoft)), you can, if desired, create a block entry in the Tenant Allow/Block List for domains and email addresses, [files](https://learn.microsoft.com/en-us/defender-office-365/submissions-admin?view=o365-worldwide#report-questionable-email-attachments-to-microsoft) and [URLs](https://learn.microsoft.com/en-us/defender-office-365/submissions-admin?view=o365-worldwide#report-questionable-urls-to-microsoft). 
